...
const FirstBlock = () => {
   return (
      <div className={classNames(c.first_block, '_container')} >
            ...
            <h1>Озеро Джека Лондона </h1>

            <p className={c.sub_title} >Март 5, 2020</p>

            <div className={c.img_wrapper} >
               <img src={firstBlock} alt="" />
         ...
         <div className={'_container'} >
            ...
            <ul className={c.accordion} >
               ...
               <li>
                  ...
                  <span>Колыма не имеет сети маркированных троп и кемпингов для ночлега, все маршруты проходят по диким нетронутым местам, преимущественно по тропам диких животных.</span>
                  <i></i>
                  <p>Что нужно знать?</p>
               </li>
               ...
               <li>
                  <input type="radio" name="elem" />
                  <span>Lorem ipsum dolor sit amet consectetur adipisicing elit. Commodi beatae quod neque expedita totam hic, laborum veniam magni at sit, officiis officia rerum itaque consequatur eos eaque animi ullam? Reprehenderit!</span>
                  <i></i>
                  <p>Жизненно необходимо иметь</p>
               </li>
