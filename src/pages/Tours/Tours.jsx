...
const MapPoint = ({ id, text, textOrientation, position, pointsData, onClick, onClose }) => {
   ...
   return (
      <>
         <div
            className={classNames(c.map_point, c[textOrientation], activePoint ? c._active : '')}
            style={{ ...position }}
                  ...
                  <div className={c.info} >
                     ...
                     {data?.map &&
                        <div className={c.info_map} >
                           <>
                              ...
                              <div style={{color:'#777',fontSize:'11px',lineHeight:'16px'}}>Powered by&nbsp;<a style={{color:'#4C8C2B',fontSize:'11px',lineHeight:'16px'}} target="_blank" href="https://ru.wikiloc.com">Wikiloc</a></div>
                           </>
                        </div>
                     }
                     ...
                     <div className={c.elements} >
                        ...
                        <div>
                           <p>Протяжённость</p>
                           <span>
                              <svg width="24" height="25" viewBox="0 0 24 25" fill="none" xmlns="http://www.w3.org/2000/svg"><g clipPath="url(#clip0_114_1565)"><path d="M19.1483 0.733398C18.2249 0.93496 17.3577 1.4834 16.7999 2.22402C16.5421 2.56152 16.2093 3.23652 16.1062 3.63965C15.9843 4.08965 15.9608 4.79746 16.0452 5.21934C16.2937 6.40996 17.3483 8.37871 18.8999 10.549L19.453 11.3225V11.7256C19.453 12.4193 19.5937 12.6631 19.9874 12.6631C20.3858 12.6631 20.5312 12.424 20.5312 11.7725V11.3459L21.0749 10.5818C22.4108 8.71621 23.3905 6.9959 23.7983 5.78184C24.2577 4.41777 23.9249 2.96934 22.9077 1.8959C22.3452 1.30527 21.614 0.892773 20.8499 0.738086C20.414 0.649023 19.5468 0.644336 19.1483 0.733398ZM20.414 3.79902C21.0843 4.10371 21.1405 5.05527 20.5171 5.47246C20.1562 5.71152 19.6921 5.66934 19.3546 5.36465C18.839 4.90059 18.9749 4.08027 19.6171 3.78027C19.814 3.68652 20.1937 3.6959 20.414 3.79902Z" fill="white"/><path d="M5.29714 8.6833C3.95652 8.82393 2.66277 9.44268 1.72527 10.3989C1.31277 10.8161 1.12996 11.0505 0.844019 11.5146C0.464332 12.1333 0.164332 12.9724 0.0518317 13.7271C-0.0231683 14.2052 -0.0137933 15.1896 0.0705817 15.6958C0.459644 18.0817 2.38621 21.2411 5.23152 24.138L5.75652 24.6724L6.49246 24.6536L7.22839 24.6396L7.36433 24.4849C7.55652 24.2739 7.55652 23.9646 7.36902 23.7771L7.23777 23.6458L7.51902 23.3458C8.21277 22.5958 9.25808 21.2739 9.83464 20.4114C10.9878 18.6958 11.705 17.0692 11.93 15.6864C12.0143 15.1661 12.0237 14.2099 11.9487 13.7271C11.6675 11.8474 10.5331 10.2442 8.85496 9.33955C8.21277 8.99268 7.41589 8.7583 6.61433 8.67861C6.07058 8.62705 5.86902 8.62705 5.29714 8.6833ZM6.79714 11.8005C7.78621 12.0911 8.63464 12.963 8.88308 13.9521C8.96746 14.2802 8.97683 14.9458 8.90183 15.2974C8.77527 15.9021 8.31589 16.6239 7.81433 17.0036C6.26277 18.1802 4.12058 17.6411 3.30496 15.8739C3.22058 15.6911 3.12683 15.4333 3.09871 15.2974C3.02371 14.9458 3.03308 14.2802 3.11746 13.9521C3.39402 12.8552 4.38777 11.9271 5.48933 11.7302C5.82214 11.6692 6.47371 11.7021 6.79714 11.8005Z" fill="white"/><path d="M19.2889 13.7834C19.2373 13.8068 19.1248 13.9146 19.0358 14.0224C18.8295 14.2802 18.4076 14.4771 17.8733 14.5662C17.3904 14.6506 17.2498 14.7349 17.1654 14.9974C17.1092 15.1662 17.1139 15.2084 17.1842 15.3631C17.3342 15.6771 17.6483 15.724 18.4217 15.5365C19.0733 15.3818 19.6592 15.0115 19.9264 14.5943C20.0436 14.4162 20.0623 14.3412 20.0436 14.1865C20.0014 13.8396 19.6311 13.6427 19.2889 13.7834Z" fill="white"/><path d="M15.0939 15.1803C14.7235 15.4287 14.4282 15.7381 14.1329 16.1975C13.6735 16.8959 13.5939 17.1818 13.786 17.449C13.8376 17.524 13.9548 17.6037 14.0626 17.6365C14.3626 17.7256 14.5501 17.599 14.8079 17.1303C15.0751 16.6521 15.3939 16.2678 15.722 16.0334C15.8579 15.935 15.9985 15.7896 16.0314 15.7146C16.172 15.3725 15.9189 15.0068 15.5485 15.0068C15.3985 15.0068 15.286 15.049 15.0939 15.1803Z" fill="white"/><path d="M13.2429 18.649C13.0648 18.6959 12.9429 18.8646 12.7226 19.385C12.6054 19.6709 12.3804 20.1443 12.2304 20.4396C11.8976 21.0818 11.8788 21.2225 12.1132 21.4568C12.2351 21.5787 12.3101 21.6162 12.446 21.6162C12.6288 21.6162 12.7882 21.5506 12.8773 21.4334C13.107 21.1475 13.8382 19.5725 13.9038 19.2256C13.9367 19.0756 13.8242 18.8037 13.6976 18.7287C13.5898 18.6584 13.3601 18.6209 13.2429 18.649Z" fill="white"/><path d="M10.4112 22.535C10.144 22.7037 9.67998 22.9475 9.3753 23.0787C8.97686 23.2428 8.79405 23.3459 8.7378 23.435C8.64405 23.5709 8.63936 23.8521 8.71905 24.0068C8.77998 24.124 9.00498 24.2412 9.15967 24.2412C9.49248 24.2412 10.7394 23.6412 11.2644 23.2334C11.4659 23.074 11.5362 22.985 11.5597 22.8584C11.6253 22.4975 11.4237 22.2256 11.0862 22.2256C10.9269 22.2256 10.805 22.2818 10.4112 22.535Z" fill="white"/></g><defs><clipPath id="clip0_114_1565"><rect width="24" height="24" fill="white" transform="translate(0 0.663086)"/></clipPath></defs></svg>
                              {data?.duration}
                           </span>
                        </div>
                        <div>
                        ...
                        <div>
                           <p>Стоимость</p>
                           <span>
                              <svg width="14" height="18" viewBox="0 0 14 18" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M8.5 0H2V9H0V11H2V13H0V15H2V18H4V15H8V13H4V11H8.5C11.54 11 14 8.54 14 5.5C14 2.46 11.54 0 8.5 0ZM8.5 9H4V2H8.5C10.43 2 12 3.57 12 5.5C12 7.43 10.43 9 8.5 9Z" fill="white"/></svg>
                              {data?.cost}
                           </span>
                        </div>
                     </div>
   ...
   return (
      <div className={c.first_block} >
         <div className='_container' >
            ...
            <h1>Прикоснитесь<br/> к природе Магадана</h1>

            <Button to='/' >Заказать тур</Button>
   ...
   return (
      <div className={classNames(c.video_block, '_container')} >
         ...
         <div className={c.text} >
            <p><span>Магадан Брат</span> — это компания, целью которой является развитие туристической привлекательности Колымского региона и популяризация пешеходного и морского экологического туризма.</p>
            <p>Мы хотим открывать вашему взору уникальную природу и культуру Колымы для туристов со всей России, показав самобытность и первозданную красоту нашего сурового края в комфортных и безопасных условиях.</p>
         ...
         <div className={c.features} >
            ...
            <p>
               <span>Суша и море</span>
               на семи континентах
            </p>

            <p>
               <span>Высшие пики Колымы</span>
               в списке восхождений
            </p>
            ...
            <p>
               <span>Путешественники со всей России</span>
               со всего мира
            </p>
      ...
      <div className={classNames(c.routes_outside_theCity_block, '_container')} >
         ...
         <div>
            ...
            <div className={c.road} >
               <hr className={c.dotted_line} />
               <div
                  className={classNames(c.map_point, c.top)}
                  style={{ left: '20%', top: 0 }}
               >
                  <span>Гора Сысынь</span>
                  <b></b>
               </div>
               <div
                  className={classNames(c.map_point, c.top)}
                  style={{ left: '50%', top: 0 }}
               >
                  <span>Гора Карамкенская Корона</span>
                  <b></b>
               </div>
            </div>
         </div>
   ...
   return (
      <div className='_container' >
         <div className={c.sea_routes} >
            ...
            <h2>Морские прогулки</h2>

            <p className={c.sub_title} >
               Туры под ключ, включено: трансфер от дома до начала маршрута и обратно, морские переходы до ключевых точек и возвращение в город, питание (завтрак, обед, ужин), фотограф, спутниковый телефон, аптечка.
            </p>
            ...
            <div className={c.map} >
               ...
               {SEA_POINTS.map(point => (
                  <Fragment key={point?.id} >
                     <MapPoint
                        ...
                        pointsData={{ [point?.id]: point?.data }}
                     ...
                     <img
                        className={classNames(c.route, activeRoute !== point?.id ? c._hidden : '')}
                        src={point?.img}
                        alt=""
                     />
                  </Fragment>
               ...
               {/* <img className={c.route} src={route_1} alt="" /> */}
               {/* <img className={c.route} src={route_2} alt="" /> */}
               {/* <img className={c.route} src={route_3} alt="" /> */}
               {/* <img className={c.route} src={route_4} alt="" /> */}
               {/* <img className={c.route} src={route_5} alt="" /> */}
               {/* <img className={c.route} src={route_6} alt="" /> */}
...
const IndividualTourBlock = () => {
   return (
      <div className={classNames(c.individual_tour_block, '_container')} >
         ...
         <img src={individualTour} alt="" />

         <div>

            <h2>Индивидуальный тур</h2>

            <p>Мы предлагаем индивидуальные туры, разработанные специально для ваших уникальных потребностей и интересов. Наша команда поможет вам создать маршрут, который соответствует вашим целям, будь то пеший маршрут по дикой местности без инфраструктуры, морское путешествие в отдалённые места или отдых и оздоровление. Семья, компания друзей, корпоративные коллективы, заядлые туристы, подберём любой маршрут под ваши нужды.</p>
...
const JackLondonLakeBlock = () => {
   return (
      <div className={classNames(c.jack_londonLake_block, '_container')} >
         ...
         <p className={c.sub_title} >
            Поход по Колыме к озеру Джека Лондона — это одно из интереснейших направлений для активных туров, которое только набирает свою популярность. Путешествие проходит по таким местам, что порой ощущаешь себя истинными первопроходцем! Да и названия здесь будто сорвались со страниц рассказов знаменитого писателя — пики Челленджер и Абориген, озера Невидимка, Мечта, Серой Чайки, Танцующих Хариусов, ручей Неведомый и тд.
            Мы совершим полноценный пеший поход от озера Джека Лондона к одной из высших  точек региона пик Абориген (2286м), устроим потрясающую рыбалку на хариуса, познакомимся с историей Колымы. Ночуем в палатках, готовим на костре, любуемся самыми яркими рассветами и закатами.
            Обратите внимание, что мы идём в начале сентября, чтобы застать сочные краски осени на озере. Это не самое комфортное время, но однозначно одно из самых красивых.
         </p>

         <h2>Озеро Джека Лондона </h2>

         <Accordion accordion={ACCORDION} />

         <Button to='/jack-london-lake' >Подробнее</Button>
