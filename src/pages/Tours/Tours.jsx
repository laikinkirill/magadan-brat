  ...
  return (
    <div className={c.first_block}>
      <div className="_container">
        ...
        <Button to="https://wa.me/79965590730" target="_blank">
          {store?.first_block?.button.val}
        </Button>
      </div>
    </div>
  );
  ...
  return (
    <div className={classNames(c.video_block, "_container")}>
      <div
        ...
        onClick={playHandler}
      >
        <video loop paused="true" src={store.video_block?.video.val}>
  ...
  return (
    <div className={classNames(c.peninsula_routes_block, "_container")}>
      ...
      <p className={c.sub_title}>
        Туры под ключ, включено: трансфер от дома до начала маршрута и обратно,
        питание (перекус и вода), фотограф, спутниковый телефон, аптечка.
        Минимум 10 человек.
      </p>
  ...
  return (
    <div className={classNames(c.jack_londonLake_block, "_container")}>
      ...
      <Button to="/jack-london-lake">
        {store.individual_tour_block?.button?.val}
      </Button>
    </div>
  );
};
