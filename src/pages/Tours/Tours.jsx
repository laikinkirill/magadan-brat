...
import { MAP_POINTS, SEA_POINTS, useTouristDestinationsPageStore } from "../../store/touristDestinationsPage"
...
const MapPoint = ({ children, textOrientation, position, data, onClick, onClose }) => {
   ...
   return (
      <div className={c.first_block} >
         <div className='_container' >
            ...
            <Button to='/' >{store?.first_block?.button.val}</Button>
      ...
      <div className='_container' >
         <div className={c.sea_routes} >
            ...
            <div className={c.map} >
               ...
               <span style={{ top: '14%', left: '45%', position: 'absolute', fontSize: 12, color: '#ACACAC' }} >
                  мыс Чирикова
               </span>

               <span style={{ top: '30%', left: '4%', position: 'absolute', fontSize: 12, color: '#ACACAC' }} >
                  остров Талан
               </span>

               <span style={{ top: '46%', left: '4%', position: 'absolute', fontSize: 12, color: '#ACACAC' }} >
                  остров Спафарьева
               </span>

               <span style={{ top: '62%', left: '68%', position: 'absolute', fontSize: 12, color: '#ACACAC' }} >
                  мыс Таран
               </span>

               <span style={{ bottom: '0', left: '72%', position: 'absolute', fontSize: 12, color: '#ACACAC' }} >
                  мыс Алевина
               </span>
   ...
   return (
      <div className={classNames(c.individual_tour_block, '_container')} >
         ...
         <div>
            ...
            <Button to='/' >{store.individual_tour_block?.button?.val}</Button>
